...
- 输出 SHA-256：`b2b30e77738ebf287235e9f8d8db03d276a0209f0d6326b4e540b05416ae7bdb`

先将可变字体固定为 `wght=400`，再把内部字体家族名改为 `GravePitch CJK`，最后仅保留：

- `U+0020..U+007E` 基本拉丁字符。
- `U+4E2D,U+4E3A,U+4E49,U+4FDD,U+51C6,U+5B58,U+5B8C,U+5B9A,U+5F26,U+6210,U+6587,U+6821,U+7F6E,U+81EA,U+8BBE,U+8C03,U+9884`。
